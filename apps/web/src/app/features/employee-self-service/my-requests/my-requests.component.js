...
exports.MyRequestsComponent = void 0;
...
let MyRequestsComponent = class MyRequestsComponent {
    ...
    get filteredRequests() {
        ...
        if (this.searchTerm) {
            ...
            filtered = filtered.filter(r => r.type.toLowerCase().includes(term) ||
...
exports.MyRequestsComponent = MyRequestsComponent = __decorate([
    (0, core_1.Component)({
