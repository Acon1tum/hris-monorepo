...
exports.AttendanceLogsComponent = void 0;
const core_1 = require("@angular/core");
const common_1 = require("@angular/common");
const forms_1 = require("@angular/forms");
let AttendanceLogsComponent = class AttendanceLogsComponent {
    ...
    get filteredLogs() {
        ...
        if (this.filters.employee) {
            filtered = filtered.filter(log => log.employeeName.toLowerCase().replace(' ', '_').includes(this.filters.employee));
        }
        if (this.filters.department) {
            filtered = filtered.filter(log => log.department.toLowerCase() === this.filters.department);
        }
        if (this.filters.logMethod) {
            filtered = filtered.filter(log => log.logMethod === this.filters.logMethod);
        }
        // Apply search
        if (this.filters.searchTerm) {
            const searchTerm = this.filters.searchTerm.toLowerCase();
            filtered = filtered.filter(log => log.employeeName.toLowerCase().includes(searchTerm) ||
...
exports.AttendanceLogsComponent = AttendanceLogsComponent;
exports.AttendanceLogsComponent = AttendanceLogsComponent = __decorate([
    (0, core_1.Component)({
...
//# sourceMappingURL=attendance-logs.component.js.map