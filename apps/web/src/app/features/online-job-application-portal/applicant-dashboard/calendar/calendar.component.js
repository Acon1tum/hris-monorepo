...
let CalendarComponent = class CalendarComponent {
    ...
    constructor(route, interviewService, router) {
        this.route = route;
    ...
    updateSelectedDayInterviews() {
        this.selectedDayInterviews = this.allInterviews.filter(i => i.date.getFullYear() === this.selectedDate.getFullYear() &&
            i.date.getMonth() === this.selectedDate.getMonth() &&
            i.date.getDate() === this.selectedDate.getDate());
    }
    getMiniDayInterviews(day) {
        return this.allInterviews.filter(i => i.date.getFullYear() === this.miniYear &&
            i.date.getMonth() === this.miniMonth &&
            i.date.getDate() === day);
    }
    getMainDayInterviews(day) {
        return this.allInterviews.filter(i => i.date.getFullYear() === this.mainYear &&
    ...
    isMiniInterviewDay(day) {
        return this.miniInterviewDays.includes(day);
    }
    isMainInterviewDay(day) {
    ...
    getInterviewsForDay(day) {
        return this.allInterviews.filter(i => i.date.getFullYear() === day.getFullYear() &&
            i.date.getMonth() === day.getMonth() &&
            i.date.getDate() === day.getDate());
    }
};
exports.CalendarComponent = CalendarComponent;
exports.CalendarComponent = CalendarComponent = __decorate([
    (0, core_1.Component)({
    ...
    __metadata("design:paramtypes", [router_1.ActivatedRoute, interview_service_1.InterviewService, router_1.Router])
], CalendarComponent);
