...
exports.RunPayrollComponent = void 0;
const core_1 = require("@angular/core");
const common_1 = require("@angular/common");
const forms_1 = require("@angular/forms");
const router_1 = require("@angular/router");
let RunPayrollComponent = class RunPayrollComponent {
    fb;
    router;
    activeTab = 'new-run';
    // New Payroll Run
    ...
    constructor(fb, router) {
        ...
        this.payrollForm = this.fb.group({
            cutoffStart: ['', forms_1.Validators.required],
            cutoffEnd: ['', forms_1.Validators.required],
    ...
    calculatePayrollSummary() {
        ...
        this.payrollSummary = {
            ...
            totalDeductions: includedEmployees.reduce((sum, emp) => sum + emp.deductions.tax + emp.deductions.insurance + emp.deductions.retirement + emp.deductions.other, 0),
...
exports.RunPayrollComponent = RunPayrollComponent;
exports.RunPayrollComponent = RunPayrollComponent = __decorate([
    (0, core_1.Component)({
...
//# sourceMappingURL=run-payroll.component.js.map